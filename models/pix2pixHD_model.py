...
class Pix2PixHDModel(BaseModel):
    ...
    def forward(self, label, inst, image, feat, mask, infer=False):
        # Encode Inputs
        input_label, inst_map, real_image, feat_map = self.encode_input(label, inst, image, feat, mask)  
